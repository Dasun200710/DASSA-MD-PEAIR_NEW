        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = '𝐃𝐀𝐒𝐒𝐀-𝐌𝐃=' + stringSession;  // Prepend your name to the session ID
                    ...
                    await SUPUNMDInc.sendMessage(userJid, { text: "𝐃𝐀𝐒𝐒𝐀-𝐌𝐃 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐒𝐔𝐂𝐂𝐄𝐒𝐅𝐔𝐋𝐋👇\n\n*⭕ YOUTUBE CHANNEL :*\n\n> https://youtube.com/@dassatech17?si=zFSF2TxTjdz3PN1s\n\n*⭕WHATSAPP GROUP:*\n\n> https://chat.whatsapp.com/K51jDuAWAwdENxOchMzfTS\n\n*⭕Contact Owner :*\n\n> https://wa.me/94743277981\n\n\n🚫 *𝗗𝗢𝗡𝗧 𝗦𝗛𝗔𝗥𝗘 𝗬𝗢𝗨𝗥 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗* 🚫" });
